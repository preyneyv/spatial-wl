...
//     struct ctwl_server *server = ctwl_output->server;
...
{
    struct ctwl_toplevel *toplevel = wl_container_of(listener, toplevel, commit);
...
{
    struct ctwl_toplevel *toplevel = wl_container_of(listener, toplevel, destroy);
...
{
    struct ctwl_server *server = wl_container_of(listener, server, new_xdg_toplevel);
